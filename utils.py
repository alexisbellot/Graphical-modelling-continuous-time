...
def simulate_lorenz_96(p, T, sigma=0.5, F=10.0, delta_t=0.1, sd=0.1, burn_in=1000, seed=None):
    if seed is not None:
        np.random.seed(seed)
...
def simulate_lotkavolterra(p, T, r, alpha, delta_t=0.1, sd=0.01, burn_in=1000, seed=None):
    if seed is not None:
        np.random.seed(seed)
...
def tumor_vaccine(
    x, t, c2, t1, a0=0.1946, a1=0.3, c1=100, c3=300, delta0=0.00001, delta1=0.00001, d=0.0007, f=0.62, r=0.01
):
    """Partial derivatives for rossler ODE."""
